          ...
          child: Column(
            ...
            children: [
              ...
              _AdminActionCard(
                ...
                subtitle: 'Gestionar catálogo de repuestos y umbrales',
                onTap: () => context.push(AppRoutes.spares),
              ),
              _AdminActionCard(
                icon: Icons.swap_horiz_rounded,
                title: AppStrings.inventory,
                subtitle: 'Registrar compras y ventas de inventario',
                onTap: () => context.push(AppRoutes.inventory),
              ),
              _AdminActionCard(
                icon: Icons.warning_amber_rounded,
                title: AppStrings.belowThreshold,
                subtitle: 'Ver repuestos críticos por debajo del umbral',
                onTap: () => context.push(AppRoutes.sparesBelowThreshold),
              ),
              _AdminActionCard(
                icon: Icons.insights_rounded,
                title: 'Métricas de inventario',
                subtitle: 'Top vendidos, ganancia, estancados y alertas',
                onTap: () => context.push(AppRoutes.adminInventoryMetrics),
              ),
              _AdminActionCard(
                icon: Icons.fact_check_rounded,
                title: AppStrings.reception,
                subtitle: 'Iniciar y confirmar recepción con código',
